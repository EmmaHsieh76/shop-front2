<template>
    ...
    <VRow>
      ...
      <VCol cols="12" md="6">
        ...
        <VForm :disabled="isSubmitting" @submit.prevent="submit" >
          <VTextField type="number" min="0"
            v-model="quantity.value.value" :error-messages="quantity.errorMessage.value"
          ></VTextField>
          <VBtn type="submit" prepend-icon="mdi-cart" :loading="isSubmitting">
            加入購物車
          </VBtn>
        </VForm>
      </VCol>
  ...
  <VOverlay class="text-center align-center justify-center" :model-value="!product.sell" persistent>
    <h1 class="text-red text-h1">已下架</h1>
    <VBtn to="/" color="green">回首頁</VBtn>
  </VOverlay>
</template>
